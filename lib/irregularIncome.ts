  ...
  const scenarios: IncomeScenario[] = [
    {
      label: 'P25',
      percentile: 25,
      grossAnnual: p25Inputs.annualSalary + p25Inputs.bonusIncome,
    ...
    },
    {
      label: 'P50',
      percentile: 50,
      grossAnnual: inputs.annualSalary + inputs.bonusIncome,
    ...
    },
    {
      label: 'P75',
      percentile: 75,
      grossAnnual: p75Inputs.annualSalary + p75Inputs.bonusIncome,
